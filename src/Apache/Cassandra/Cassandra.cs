  ...
  public partial class Cassandra {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (ColumnOrSuperColumn _iter111 in Success)
              {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (byte[] _iter123 in Success.Keys)
              {
                oprot.WriteBinary(_iter123);
                {
                  oprot.WriteListBegin(new TList(TType.Struct, Success[_iter123].Count));
                  foreach (ColumnOrSuperColumn _iter124 in Success[_iter123])
                  {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    KeySlice _elem136 = new KeySlice();
                    _elem136 = new KeySlice();
                    _elem136.Read(iprot);
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (KeySlice _iter137 in Success)
              {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    KeySlice _elem140 = new KeySlice();
    ...
    public partial class atomic_batch_mutate_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        ...
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.Map, Mutation_map.Count));
          foreach (byte[] _iter179 in Mutation_map.Keys)
          {
            oprot.WriteBinary(_iter179);
            {
              oprot.WriteMapBegin(new TMap(TType.String, TType.List, Mutation_map[_iter179].Count));
              foreach (string _iter180 in Mutation_map[_iter179].Keys)
              {
                oprot.WriteString(_iter180);
                {
                  oprot.WriteListBegin(new TList(TType.Struct, Mutation_map[_iter179][_iter180].Count));
                  foreach (Mutation _iter181 in Mutation_map[_iter179][_iter180])
                  {
          ...
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter189 in Success.Keys)
              {
                ...
                {
                  oprot.WriteListBegin(new TList(TType.String, Success[_iter189].Count));
                  foreach (string _iter190 in Success[_iter189])
                  {
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (KsDef _iter194 in Success)
              {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TokenRange _elem197 = new TokenRange();
                    _elem197 = new TokenRange();
                    _elem197.Read(iprot);
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (TokenRange _iter198 in Success)
              {
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (TokenRange _iter202 in Success)
              {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter207 in Success.Keys)
              {
                oprot.WriteString(_iter207);
                oprot.WriteString(Success[_iter207]);
              }
              oprot.WriteMapEnd();
            }
            oprot.WriteFieldEnd();
    ...
    public partial class execute_prepared_cql_query_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (byte[] _iter219 in Values)
          {
