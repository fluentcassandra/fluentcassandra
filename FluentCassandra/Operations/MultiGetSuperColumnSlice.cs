...
{
	public class MultiGetSuperColumnSlice<CompareWith, CompareSubcolumnWith> : ColumnFamilyOperation<IEnumerable<IFluentSuperColumn<CompareWith, CompareSubcolumnWith>>>
