...
{
	public class MultiGetSuperColumnFamilySlice<CompareWith, CompareSubcolumnWith> : ColumnFamilyOperation<IEnumerable<IFluentSuperColumnFamily<CompareWith, CompareSubcolumnWith>>>
